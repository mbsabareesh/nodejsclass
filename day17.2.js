                ...
                try {
                    ...
                    if(update_array.length>0){
                        update_array.forEach(item =>{
                            var update_sql = `
                            update item_table 
                            set product_name = 'watch', product_id = 'md-08', amount_with_tax = 10000, amount_without_tax = 10000,gst = 18, gst_amount = 1000, CGST = NULL, SGST = NULL, IGST = 18 WHERE cusid = 4`;
